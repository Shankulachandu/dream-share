  ...
  return (
    <div style={styles.card}>
      ...
      <div style={styles.footer}>
        <button onClick={handleLike} style={{ ...styles.actionBtn, color: liked ? '#e74c3c' : '#a0a0b0' }}>
...
const styles = {
  ...
  avatar: { width: '42px', height: '42px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: '700', fontSize: '16px', flexShrink: 0 },
  ...
  moodTag: { fontSize: '11px', fontWeight: '600', padding: '2px 8px', borderRadius: '20px', border: '1px solid', opacity: 0.9 },
  time: { fontSize: '11px', color: '#6b7280' },
  optionsWrap: { position: 'relative' },
  optionsBtn: { background: 'none', border: 'none', color: '#6b7280', cursor: 'pointer', fontSize: '20px', padding: '4px 8px', borderRadius: '8px', letterSpacing: '2px', lineHeight: '1' },
  optionsMenu: { position: 'absolute', top: '32px', right: 0, background: '#1a1a2e', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '12px', overflow: 'hidden', zIndex: 50, minWidth: '160px', boxShadow: '0 8px 24px rgba(0,0,0,0.4)' },
  deleteOption: { display: 'block', width: '100%', padding: '12px 16px', background: 'none', border: 'none', color: '#ef4444', cursor: 'pointer', fontSize: '14px', textAlign: 'left', fontWeight: '500' },
  confirmBox: { margin: '0 16px 12px', background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: '12px', padding: '14px' },
  confirmText: { color: '#fca5a5', fontSize: '13px', marginBottom: '12px', textAlign: 'center' },
  confirmBtns: { display: 'flex', gap: '8px' },
  confirmCancel: { flex: 1, padding: '8px', background: 'rgba(255,255,255,0.05)', color: '#a0a0b0', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', cursor: 'pointer', fontSize: '13px' },
  confirmDelete: { flex: 1, padding: '8px', background: '#ef4444', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '13px', fontWeight: '600' },
  ...
  aiBox: { margin: '0 16px 16px', background: 'rgba(108,99,255,0.1)', border: '1px solid rgba(108,99,255,0.3)', borderRadius: '12px', padding: '14px' },
  ...
  footer: { display: 'flex', alignItems: 'center', gap: '4px', padding: '8px 12px 12px', borderTop: '1px solid rgba(255,255,255,0.06)' },
  actionBtn: { background: 'none', border: 'none', cursor: 'pointer', fontSize: '13px', color: '#a0a0b0', padding: '6px 12px', borderRadius: '8px', fontWeight: '500' },
  interpretBtn: { background: 'rgba(108,99,255,0.15)', border: '1px solid rgba(108,99,255,0.3)', color: '#a78bfa', padding: '5px 12px', borderRadius: '20px', cursor: 'pointer', fontSize: '12px', fontWeight: '600', marginLeft: 'auto' },
  commentsBox: { padding: '12px 16px 16px', borderTop: '1px solid rgba(255,255,255,0.06)', background: 'rgba(0,0,0,0.2)' },
  ...
  commentAvatar: { width: '28px', height: '28px', borderRadius: '50%', background: 'linear-gradient(135deg, #6c63ff, #a78bfa)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', fontWeight: '700', flexShrink: 0 },
  commentContent: { background: 'rgba(255,255,255,0.05)', borderRadius: '10px', padding: '8px 12px', flex: 1 },
  commentUser: { fontWeight: '600', fontSize: '12px', color: '#a78bfa', display: 'block', marginBottom: '2px' },
  commentText: { fontSize: '13px', color: '#d0d0d0' },
  commentInputRow: { display: 'flex', gap: '8px', marginTop: '12px' },
  commentInput: { flex: 1, padding: '10px 14px', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.05)', color: 'white', fontSize: '13px', outline: 'none' },
  sendBtn: { background: 'linear-gradient(135deg, #6c63ff, #a78bfa)', color: 'white', border: 'none', padding: '10px 18px', borderRadius: '20px', cursor: 'pointer', fontSize: '13px', fontWeight: '600' }
};
